...
print("Classification Report BERT terms (Table 6):", classification_report(y_test, y_pred_original, digits=4))
...
print("Classification Report BERT descriptions (Table6). The following are the correct results; please note that there is an error in the results reported in the paper. The correct results are:\n", classification_report(y_test, y_pred_original, digits=4))