...
best_model = load_model('main_comparison/cve_description/CWE_classes_class.h5')

# Load the label encoder
label_encoder_train = joblib.load('main_comparison/cve_description/label_encoder_train_class.joblib')
...
print("Classification Report CVE description classes (Table4):\n", classification_report(y_test, y_pred_original, digits=4))